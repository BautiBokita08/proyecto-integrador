...
const badgeFavoritos = document.getElementById("badge-favoritos-contador");

// 🔍 Campo de texto del buscador y colección con todos los botones de categorías:
const inputBuscador = document.getElementById("input-buscador");
const botonesFiltro = document.getElementsByClassName("filtros-categorias");
...
const totalProductosSpan = document.getElementById("total-productos-visibles");
const totalPrecioSpan = document.getElementById("total-precio-acumulado");
...
const sinResultadosBox = document.getElementById("sin-resultados");
...
function aplicarFiltros() {
    ...
    if (productosFiltrados.length === 0) {
        ...
        contenedorCatalogo.innerHTML = productosFiltrados
            .map(prod => crearTarjetaProductoHTML(prod, esProductoFavorito(prod.id)))
            .join("");
    }
}
